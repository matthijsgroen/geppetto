...
- The **smoke** is done by 2 [deformation][] mutators changing the shape of the model,
  in combination with a [translation][] mutation moving the model through the
  deformations causing the smoke to bend and rise.
