...
export const RangeInput: FC<RangeInputProps> = (props) => (
  <input
    className={clsx(
      ...
      `thumb:-m-1.5 thumb:size-4 thumb:appearance-none thumb:rounded-full thumb:border-2 thumb:border-control-interaction thumb:bg-control-interaction thumb:shadow-md hover:thumb:border-control-highlight focus:thumb:border-control-focus`,
