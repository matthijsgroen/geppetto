import{p as d,j as e}from"./iframe-jl7oPzfV.js";import{I as t}from"./Icon-Bo5a_kWh.js";import{T as m}from"./ToolButton-DzUaFgeo.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./Label-Dl2pAVjB.js";import"./ToolBarContext-DIKXAc5j.js";const{expect:u,fn:g,waitFor:y}=__STORYBOOK_MODULE_TEST__,n=d.meta({title:"Atoms/ToolButton",component:m,argTypes:{icon:{control:!1},onClick:{control:!1},onKeyDown:{control:!1},ref:{control:!1},onContextMenu:{control:!1},label:{control:"text"},tooltip:{control:"text"}},args:{disabled:!1,active:!1,notificationBadge:!1,standAlone:!1,onClick:g()}}),a=n.story({args:{icon:e.jsx(t,{children:"💡"})},play:async({canvas:i,userEvent:l,args:p})=>{await l.click(i.getByRole("button")),await u(p.onClick).toHaveBeenCalled()}}),o=n.story({args:{icon:e.jsx(t,{children:"💡"}),active:!0}}),r=n.story({args:{icon:e.jsx(t,{children:"💡"}),label:"Button"}}),s=n.story({args:{icon:e.jsx(t,{children:"💡"}),disabled:!0},play:async({args:i,canvas:l,userEvent:p})=>{await p.click(l.getByRole("button")),await y(()=>u(i.onClick).not.toHaveBeenCalled())}}),c=n.story({args:{icon:e.jsx(t,{children:"💡"}),disabled:!0,active:!0}});a.input.parameters={...a.input.parameters,docs:{...a.input.parameters?.docs,source:{originalSource:`meta.story({
  args: {
    icon: <Icon>💡</Icon>
  },
  play: async ({
