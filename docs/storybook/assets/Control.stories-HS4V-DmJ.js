import{p,j as e,a as u,y as i,N as a,R as c,r as d}from"./iframe-BjqMxiNP.js";import"./preload-helper-PPVm8Dsz.js";const s=p.meta({title:"Molecules/Control",component:u,argTypes:{children:{control:!1}},args:{label:"Label",htmlFor:"InputField"},decorators:[l=>e.jsx("div",{children:e.jsx(i,{children:e.jsx(l,{})})})]}),r=s.story({args:{children:e.jsx(a,{htmlId:"InputField",prefix:"x:",value:10})}}),t=s.story({args:{children:[e.jsx(a,{htmlId:"InputField",prefix:"x:",value:10},"x"),e.jsx(a,{prefix:"y:",value:10},"y")]}}),n=s.story({args:{children:e.jsx(c,{id:"InputField",value:10})}}),o=s.story({args:{children:e.jsx(d,{checked:!0,id:"InputField"})}});r.input.parameters={...r.input.parameters,docs:{...r.input.parameters?.docs,source:{originalSource:`meta.story({
  args: {
...
})`,...o.input.parameters?.docs?.source}}};const x=["NumberControl","VectorControl","SliderControl","ToggleControl"];export{r as NumberControl,n as SliderControl,o as ToggleControl,t as VectorControl,x as __namedExportsOrder,s as default};
