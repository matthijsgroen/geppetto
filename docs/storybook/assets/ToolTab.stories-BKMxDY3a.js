import{p as v,j as o}from"./iframe-jl7oPzfV.js";import{I as s}from"./Icon-Bo5a_kWh.js";import{T as g}from"./ToolTab-D3v0EC2n.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./Label-Dl2pAVjB.js";import"./ToolBarContext-DIKXAc5j.js";const{expect:p,fn:y,userEvent:u,waitFor:m,within:d}=__STORYBOOK_MODULE_TEST__,r=v.meta({title:"Atoms/ToolTab",component:g,argTypes:{icon:{control:!1},label:{control:"text"}},args:{disabled:!1,active:!1,vertical:!1,onClick:y()}}),a=r.story({args:{icon:o.jsx(s,{children:"💡"}),label:"Canvas"},play:async({args:c,canvasElement:i})=>{const l=d(i);await u.click(l.getByRole("button")),await m(()=>p(c.onClick).toHaveBeenCalled())}}),e=r.story({args:{icon:o.jsx(s,{children:"💡"}),active:!0}}),n=r.story({args:{icon:o.jsx(s,{children:"💡"}),disabled:!0},play:async({args:c,canvasElement:i})=>{const l=d(i);await u.click(l.getByRole("button")),await m(()=>p(c.onClick).not.toHaveBeenCalled())}}),t=r.story({args:{icon:o.jsx(s,{children:"💡"}),disabled:!0,active:!0}});a.input.parameters={...a.input.parameters,docs:{...a.input.parameters?.docs,source:{originalSource:`meta.story({
  args: {
    icon: <Icon>💡</Icon>,
    label: "Canvas"
  },
